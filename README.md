...
* [Drogon](https://github.com/filipi86/drogonsec) ⭐ 176 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - High-performance open-source scanner combining SAST, SCA, secret detection, and IaC analysis for Terraform and other formats, built for CI/CD pipelines.
* [SonarQube IaC Analysis](https://github.com/SonarSource/sonar-iac) ⭐ 58 | 🐛 6 | 🌐 Java | 📅 2026-09-07 - SonarSource's IaC static analyzer covering Terraform, CloudFormation, Kubernetes, and Docker with security and quality rules.
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,802 | 🐛 31 | 🌐 Go | 📅 2026-09-06 - Pluggable Terraform linter with AWS, Azure, and GCP rulesets for detecting errors and enforcing best practices.
* [CloudFormation Guard (cfn-guard)](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,388 | 🐛 54 | 🌐 Rust | 📅 2026-09-07 - Policy-as-code DSL from AWS for writing rules that validate JSON and YAML data, including Terraform plan JSON and HCL configurations.
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 928 | 🐛 5 | 🌐 HCL | 📅 2026-09-07 - Scans Terraform and OpenTofu code to calculate the minimum IAM permissions required for deployment across AWS, GCP, and Azure.
* [Tirith](https://github.com/StackGuardian/tirith) ⭐ 166 | 🐛 112 | 🌐 Python | 📅 2026-09-04 - Policy framework for Terraform stacks that evaluates infrastructure configurations against compliance policies defined in JSON.
...
* [TerraGoat](https://github.com/bridgecrewio/terragoat) ⭐ 1,303 | 🐛 61 | 🌐 HCL | 📅 2025-07-13 - Bridgecrew's "vulnerable by design" Terraform repository covering common misconfigurations across AWS, Azure, and GCP.
* [sadcloud](https://github.com/nccgroup/sadcloud) ⭐ 789 | 🐛 9 | 🌐 HCL | 📅 2023-10-14 - NCC Group's tool for spinning up intentionally misconfigured AWS infrastructure via Terraform to test detection coverage.
...
* [GCP Hardening Toolkit (GHT)](https://github.com/GoogleCloudPlatform/gcp-hardening-toolkit) ⭐ 41 | 🐛 5 | 🌐 HCL | 📅 2026-09-07 - Google-maintained Terraform modules and blueprints for incrementally hardening brownfield GCP environments, with custom IAM role generation and organization policy constraints.
...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,768 | 🐛 384 | 🌐 Python | 📅 2026-09-07 - Open-source security assessment tool for AWS, Azure, GCP, and Kubernetes covering CIS, PCI, HIPAA, SOC 2, ISO 27001, and more.
...
* [Compliance Trestle](https://github.com/oscal-compass/compliance-trestle) ⭐ 274 | 🐛 45 | 🌐 Python | 📅 2026-09-04 - SDK and CLI for creating and validating OSCAL documents, part of the OSCAL Compass project.
...
* [mapotf](https://github.com/Azure/mapotf) ⭐ 60 | 🐛 4 | 🌐 Go | 📅 2026-09-04 - Meta-programming tool for Terraform that matches and transforms HCL blocks, letting module authors inject governance patterns such as `ignore_changes` rules and private-endpoint wrappers across existing modules.
...
* [atlantis-drift-detection](https://github.com/cresta/atlantis-drift-detection) ⭐ 116 | 🐛 19 | 🌐 Go | 📅 2026-09-05 - Runs Atlantis-driven `terraform plan` across every project in an `atlantis.yaml` monorepo, reports drift and untracked workspaces to Slack, and optionally triggers remediation workflows.
...
* [tflint-ruleset-opa](https://github.com/terraform-linters/tflint-ruleset-opa) ⭐ 86 | 🐛 4 | 🌐 Go | 📅 2026-09-07 - TFLint plugin for writing custom compliance rules in Rego, bridging tflint's Terraform-native linting with OPA policy evaluation.
...
* [AWS Guard Rules Registry](https://github.com/aws-cloudformation/aws-guard-rules-registry) ⭐ 143 | 🐛 35 | 🌐 Python | 📅 2024-03-25 - Official AWS registry of Guard rules covering CIS, NIST, PCI DSS, HIPAA, and SOC 2 compliance frameworks, applicable to Terraform plan JSON via cfn-guard.
...
* [OTF](https://github.com/leg100/otf) ⭐ 703 | 🐛 28 | 🌐 Go | 📅 2026-07-16 - Open-source alternative to Terraform Enterprise with SSO, team management, and agent support, no per-resource pricing.
* [Terrapod](https://github.com/mattrobinsonsre/terrapod) ⭐ 256 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - Open-source, self-hosted Terraform and OpenTofu automation platform with governance controls, drift detection, RBAC, and HCP Terraform API compatibility.
...
* [Pre-commit Terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,767 | 🐛 26 | 🌐 Shell | 📅 2026-09-05 - Collection of Git pre-commit hooks for Terraform including linting, validation, and security scanning.
...
* [awesome-tf](https://github.com/shuaibiyy/awesome-tf) ⭐ 6,590 | 🐛 3 | 📅 2026-09-07 - Curated Terraform and OpenTofu resources.
* [awesome-cloud-security](https://github.com/4ndersonLin/awesome-cloud-security) ⭐ 2,487 | 🐛 22 | 📅 2026-03-17 - Cloud security resources across AWS, Azure, and GCP.
* [awesome-devsecops](https://github.com/JakobTheDev/awesome-devsecops) ⭐ 1,724 | 🐛 40 | 📅 2024-08-02 - DevSecOps tools and resources including IaC security.
