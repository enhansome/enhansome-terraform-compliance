...
* [Drogon](https://github.com/filipi86/drogonsec) ⭐ 183 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - High-performance open-source scanner combining SAST, SCA, secret detection, and IaC analysis for Terraform and other formats, built for CI/CD pipelines.
* [SonarQube IaC Analysis](https://github.com/SonarSource/sonar-iac) ⭐ 59 | 🐛 6 | 🌐 Java | 📅 2026-09-25 - SonarSource's IaC static analyzer covering Terraform, CloudFormation, Kubernetes, and Docker with security and quality rules.
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,822 | 🐛 32 | 🌐 Go | 📅 2026-09-24 - Pluggable Terraform linter with AWS, Azure, and GCP rulesets for detecting errors and enforcing best practices.
...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,863 | 🐛 382 | 🌐 Python | 📅 2026-09-25 - Open-source security assessment tool for AWS, Azure, GCP, and Kubernetes covering CIS, PCI, HIPAA, SOC 2, ISO 27001, and more.
...
* [Compliance Trestle](https://github.com/oscal-compass/compliance-trestle) ⭐ 280 | 🐛 44 | 🌐 Python | 📅 2026-09-24 - SDK and CLI for creating and validating OSCAL documents, part of the OSCAL Compass project.
...
* [DriftHound](https://github.com/treezio/drifthound) ⭐ 71 | 🐛 22 | 🌐 Ruby | 📅 2026-04-23 - Receives Terraform drift reports via API and provides a web dashboard with historical tracking, analytics, and Slack notifications.
...
* [Terrapod](https://github.com/mattrobinsonsre/terrapod) ⭐ 259 | 🐛 12 | 🌐 Python | 📅 2026-09-25 - Open-source, self-hosted Terraform and OpenTofu automation platform with governance controls, drift detection, RBAC, and HCP Terraform API compatibility.
...
* [Pre-commit Terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,778 | 🐛 30 | 🌐 Shell | 📅 2026-09-25 - Collection of Git pre-commit hooks for Terraform including linting, validation, and security scanning.
...
* [awesome-tf](https://github.com/shuaibiyy/awesome-tf) ⭐ 6,601 | 🐛 5 | 📅 2026-09-21 - Curated Terraform and OpenTofu resources.
