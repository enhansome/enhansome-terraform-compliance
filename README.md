...
* [Drogon](https://github.com/filipi86/drogonsec) ⭐ 178 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - High-performance open-source scanner combining SAST, SCA, secret detection, and IaC analysis for Terraform and other formats, built for CI/CD pipelines.
* [SonarQube IaC Analysis](https://github.com/SonarSource/sonar-iac) ⭐ 59 | 🐛 6 | 🌐 Java | 📅 2026-09-21 - SonarSource's IaC static analyzer covering Terraform, CloudFormation, Kubernetes, and Docker with security and quality rules.
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,819 | 🐛 32 | 🌐 Go | 📅 2026-09-19 - Pluggable Terraform linter with AWS, Azure, and GCP rulesets for detecting errors and enforcing best practices.
...
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 929 | 🐛 5 | 🌐 HCL | 📅 2026-09-21 - Scans Terraform and OpenTofu code to calculate the minimum IAM permissions required for deployment across AWS, GCP, and Azure.
...
* [TerraGoat](https://github.com/bridgecrewio/terragoat) ⭐ 1,306 | 🐛 62 | 🌐 HCL | 📅 2025-07-13 - Bridgecrew's "vulnerable by design" Terraform repository covering common misconfigurations across AWS, Azure, and GCP.
...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,844 | 🐛 384 | 🌐 Python | 📅 2026-09-21 - Open-source security assessment tool for AWS, Azure, GCP, and Kubernetes covering CIS, PCI, HIPAA, SOC 2, ISO 27001, and more.
...
* [Compliance Trestle](https://github.com/oscal-compass/compliance-trestle) ⭐ 277 | 🐛 42 | 🌐 Python | 📅 2026-09-21 - SDK and CLI for creating and validating OSCAL documents, part of the OSCAL Compass project.
...
* [Yor](https://github.com/bridgecrewio/yor) ⭐ 932 | 🐛 9 | 🌐 Go | 📅 2026-09-18 - Automated IaC tagging tool that applies Git metadata, trace identifiers, and custom tags to Terraform resources for audit trail and ownership tracking.
* [mapotf](https://github.com/Azure/mapotf) ⭐ 60 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - Meta-programming tool for Terraform that matches and transforms HCL blocks, letting module authors inject governance patterns such as `ignore_changes` rules and private-endpoint wrappers across existing modules.
...
* [atlantis-drift-detection](https://github.com/cresta/atlantis-drift-detection) ⭐ 116 | 🐛 20 | 🌐 Go | 📅 2026-09-21 - Runs Atlantis-driven `terraform plan` across every project in an `atlantis.yaml` monorepo, reports drift and untracked workspaces to Slack, and optionally triggers remediation workflows.
...
* [tflint-ruleset-opa](https://github.com/terraform-linters/tflint-ruleset-opa) ⭐ 86 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - TFLint plugin for writing custom compliance rules in Rego, bridging tflint's Terraform-native linting with OPA policy evaluation.
...
* [AWS Guard Rules Registry](https://github.com/aws-cloudformation/aws-guard-rules-registry) ⭐ 144 | 🐛 34 | 🌐 Python | 📅 2024-03-25 - Official AWS registry of Guard rules covering CIS, NIST, PCI DSS, HIPAA, and SOC 2 compliance frameworks, applicable to Terraform plan JSON via cfn-guard.
...
* [Terrapod](https://github.com/mattrobinsonsre/terrapod) ⭐ 259 | 🐛 14 | 🌐 Python | 📅 2026-09-21 - Open-source, self-hosted Terraform and OpenTofu automation platform with governance controls, drift detection, RBAC, and HCP Terraform API compatibility.
...
* [Pre-commit Terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,776 | 🐛 27 | 🌐 Shell | 📅 2026-09-21 - Collection of Git pre-commit hooks for Terraform including linting, validation, and security scanning.
...
* [awesome-tf](https://github.com/shuaibiyy/awesome-tf) ⭐ 6,594 | 🐛 3 | 📅 2026-09-21 - Curated Terraform and OpenTofu resources.
...
* [awesome-devsecops](https://github.com/JakobTheDev/awesome-devsecops) ⭐ 1,733 | 🐛 45 | 📅 2024-08-02 - DevSecOps tools and resources including IaC security.
