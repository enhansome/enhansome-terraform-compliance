...
* [SonarQube IaC Analysis](https://github.com/SonarSource/sonar-iac) ⭐ 58 | 🐛 6 | 🌐 Java | 📅 2026-08-24 - SonarSource's IaC static analyzer covering Terraform, CloudFormation, Kubernetes, and Docker with security and quality rules.
...
* [CloudFormation Guard (cfn-guard)](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,385 | 🐛 53 | 🌐 Rust | 📅 2026-08-25 - Policy-as-code DSL from AWS for writing rules that validate JSON and YAML data, including Terraform plan JSON and HCL configurations.
...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,671 | 🐛 283 | 🌐 Python | 📅 2026-08-24 - Open-source security assessment tool for AWS, Azure, GCP, and Kubernetes covering CIS, PCI, HIPAA, SOC 2, ISO 27001, and more.
...
* [Compliance Trestle](https://github.com/oscal-compass/compliance-trestle) ⭐ 271 | 🐛 45 | 🌐 Python | 📅 2026-08-24 - SDK and CLI for creating and validating OSCAL documents, part of the OSCAL Compass project.
...
* [Pre-commit Terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,759 | 🐛 26 | 🌐 Shell | 📅 2026-08-21 - Collection of Git pre-commit hooks for Terraform including linting, validation, and security scanning.
...
* [awesome-tf](https://github.com/shuaibiyy/awesome-tf) ⭐ 6,582 | 🐛 9 | 📅 2026-08-24 - Curated Terraform and OpenTofu resources.
...
* [awesome-opa](https://github.com/open-policy-agent/awesome-opa) ⭐ 900 | 🐛 4 | 📅 2026-08-17 - Open Policy Agent tools, frameworks, and articles.
